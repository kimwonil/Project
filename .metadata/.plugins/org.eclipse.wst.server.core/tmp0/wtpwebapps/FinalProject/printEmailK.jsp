...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-40" data-genuitec-path="/FinalProject/WebContent/printEmailK.jsp">


유저정보 출력 [카카오 로그인 성공시!]

<a id="kakao-login-btn" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-40" data-genuitec-path="/FinalProject/WebContent/printEmailK.jsp"></a>
