...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/FinalProject/WebContent/member/message.jsp">

	
	<div id="fh5co-main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/FinalProject/WebContent/member/message.jsp">
		<div class="container">
			<div class="row">
