...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/FinalProject/WebContent/loginprototype.jsp">
...
-->
<!-- 네이버 아이디로 로그인 버튼 -->
<div id="naver_id_login" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/FinalProject/WebContent/loginprototype.jsp"></div>
<!-- 네이버 아이디로 로그인 버튼 -->
