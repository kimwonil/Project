...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-25" data-genuitec-path="/FinalProject/WebContent/loginAfter.jsp">
로그인 후 페이지

이메일 : <label id="email" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-25" data-genuitec-path="/FinalProject/WebContent/loginAfter.jsp">${email}</label>
