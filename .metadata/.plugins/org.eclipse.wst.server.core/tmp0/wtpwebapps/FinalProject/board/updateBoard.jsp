...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/FinalProject/WebContent/board/updateBoard.jsp">
	
	<!-- 	<div id="fh5co-main"> -->
		<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/FinalProject/WebContent/board/updateBoard.jsp">
			<div class="row">
