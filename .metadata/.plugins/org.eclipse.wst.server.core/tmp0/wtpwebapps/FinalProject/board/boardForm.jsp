...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/FinalProject/WebContent/board/boardForm.jsp">
	
	<!-- 	<div id="fh5co-main"> -->
		<div class="container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/FinalProject/WebContent/board/boardForm.jsp">
			<div class="row">
