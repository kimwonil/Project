...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/FinalProject/WebContent/board/detail.jsp">

	<div id="fh5co-main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/FinalProject/WebContent/board/detail.jsp">
		<div class="container">
			<div class="row">
