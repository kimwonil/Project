...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/FinalProject/WebContent/loginTest.jsp">

<!-- 네이버아이디로로그인 버튼 노출 영역 -->
<div id="naver_id_login" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/FinalProject/WebContent/loginTest.jsp"></div>
<!-- //네이버아이디로로그인 버튼 노출 영역 -->
